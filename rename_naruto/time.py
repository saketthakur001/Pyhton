import pysrt
episode_name = 'Prison.Break.S01E02.480p.English.Esubs.MoviesFlix.srt'
...
times = 0
acceleration = 110 / 2537 # video and sub difference divided by last subtitle time in sec
for sub in subs:
    #print('waht is going onalksdjflasjflaskjflsakjfalsdjfaasfasdfasd')
    print(sub)
    sub = str(sub)
